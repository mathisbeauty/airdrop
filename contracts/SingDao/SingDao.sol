...
contract SingDao is Ownable {
    ...
    function mint(address dst, uint256 rawAmount) external onlyOwner {
        // mint the amount
        require(
            dst != address(0),
        ...
        totalSupply = safe96(
            ...
            "Sdao::mint: totalSupply exceeds 96 bits"
        );
        ...
        balances[dst] = add96(
            balances[dst],
            amount,
            "Sdao::mint: transfer amount overflows"
        );
    ...
    function transfer(address dst, uint256 rawAmount) external returns (bool) {
        uint96 amount = safe96(
            rawAmount,
            "SDAO::transfer: amount exceeds 96 bits"
        );
    ...
    function transferFrom(
        ...
        uint96 amount = safe96(
            rawAmount,
            "SDAO::approve: amount exceeds 96 bits"
        );
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "sdao::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "sdao::delegateBySig: invalid nonce"
        );
